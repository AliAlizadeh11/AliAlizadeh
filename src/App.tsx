...
import profilePic from './assets/Ali-photo.jpeg'; // Updated image import
...
const Navbar: React.FC = () => {
    ...
    return (
        <header className="w-full max-w-6xl flex justify-between items-center mb-10 text-white">
            <div className="text-2xl font-bold dark:text-white text-gray-800">Ali Alizadeh Profile</div>
...
const Hero: React.FC = () => {
    return (
        <section className="w-full max-w-6xl flex flex-col md:flex-row items-center justify-between py-20 px-4 sm:px-6 lg:px-8 bg-transparent mb-10">
            <div className="md:w-1/2 text-left mb-10 md:mb-0">
                <p className="text-xl dark:text-gray-400 text-gray-600 mb-2">Hi, my name is</p>
                <h1 className="text-6xl sm:text-7xl font-extrabold dark:text-white text-gray-900 mb-4">Ali Alizadeh</h1>
                <h2 className="text-3xl sm:text-4xl font-semibold dark:text-gray-300 text-gray-700 mb-8">Computer Engineering Student</h2>

                <div className="flex items-center space-x-4">
                    <a href={require('./assets/AliAlizadeh-CV.pdf')} target="_blank" rel="noopener noreferrer" className="px-6 py-3 border border-gray-500 dark:text-white text-gray-800 rounded-lg hover:bg-gray-700 dark:hover:bg-gray-700 hover:text-white dark:hover:text-white transition duration-300 ease-in-out">
                        Resume
                    </a>
            ...
            <div className="md:w-1/2 flex justify-center md:justify-end">
                ...
                <img src={profilePic} alt="Ali Alizadeh Profile" className="rounded-xl shadow-lg w-full max-w-sm" />
            </div>
        </section>
    );
};
...
const ResearchInterests: React.FC = () => {
    ...
    return (
        <section id="research-interests" className="card">
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 gap-4 dark:text-gray-300 text-gray-700">
                {researchTopics.map((topic) => (
                    <div key={topic.id} className="rounded-md p-4 flex flex-col dark:text-gray-300 text-gray-700">
                        <span className="font-semibold dark:text-gray-300 text-gray-700">{topic.text.split(':')[0]}:</span> <span className="dark:text-gray-300 text-gray-700">{topic.text.split(':')[1]}</span>
                        ...
                        {expandedInterest && currentInterestId === topic.id && (
                            <div className="mt-2 p-3 bg-gray-800 rounded-md dark:text-gray-300 text-gray-700">
                                <p className="text-gray-700 dark:text-gray-300">{expandedInterest}</p>
        ...
        <section id="contact" className="card">
            ...
            <div className="flex justify-center gap-4 mt-8">
                ...
                <a href="https://www.linkedin.com/in/ali-alizadeh-1153b721a/" target="_blank" rel="noopener noreferrer" className="text-white bg-blue-700 rounded-lg p-3 hover:scale-110 transition-transform duration-100">
                    <i className="fab fa-linkedin-in text-3xl"></i> {/* Often 'linkedin-in' for the logo without the word */}
                </a>
...
<section id="skills" className="card">
    ...
    <h2 className="dark:text-gray-300 text-gray-700 text-3xl font-bold section-heading">Skills</h2>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-8 dark:text-gray-300 text-gray-700">

            {/* AI & Machine Learning Card */}
            <div className="dark:text-gray-300 text-gray-700 rounded-lg shadow-xl p-6 hover:shadow-2xl transition-shadow duration-300">
                <h3 className="text-2xl font-bold dark:text-gray-300 text-gray-700 mb-4">AI & Machine Learning</h3>
                <div className="space-y-4">
                    <div>
                        <h4 className="text-xl font-semibold dark:text-gray-300 text-gray-700 mb-2">Frameworks/Libraries:</h4>
                        <p className="dark:text-gray-300 text-gray-700 leading-relaxed">TensorFlow, PyTorch, Keras, Scikit-learn, NumPy, Pandas</p>
                    </div>
                    <div>
                        <h4 className="text-xl font-semibold dark:text-gray-300 text-gray-700 mb-2">Core Concepts:</h4>
                        <p className="dark:text-gray-300 text-gray-700 leading-relaxed">Deep Learning (CNNs, RNNs, Transformers), LLMs, Natural Language Processing (NLP), Computer Vision</p>
                    </div>
                </div>
            </div>

            {/* Web Development & Programming Card */}
            <div className="rounded-lg shadow-xl p-6 hover:shadow-2xl transition-shadow duration-300">
                <h3 className="text-2xl font-bold dark:text-gray-300 text-gray-700 mb-4">Web Development & Programming</h3>
                <div className="space-y-4">
                    <div>
                        <h4 className="text-xl font-semibold dark:text-gray-300 text-gray-700 mb-2">Languages:</h4>
                        <p className="dark:text-gray-300 text-gray-700 leading-relaxed">Python, JavaScript, TypeScript, Go, C/C++</p>
                    </div>
                    <div>
                        <h4 className="text-xl font-semibold dark:text-gray-300 text-gray-700 mb-2">Backend:</h4>
                        <p className="dark:text-gray-300 text-gray-700 leading-relaxed">FastAPI, Django, Fiber (Go), GORM</p>
                    </div>
                    <div>
                        <h4 className="text-xl font-semibold dark:text-gray-300 text-gray-700 mb-2">Frontend:</h4>
                        <p className="dark:text-gray-300 text-gray-700 leading-relaxed">React, HTML5, CSS3</p>
                    </div>
                    <div>
                        <h4 className="text-xl font-semibold dark:text-gray-300 text-gray-700 mb-2">Databases:</h4>
                        <p className="dark:text-gray-300 text-gray-700 leading-relaxed">PostgreSQL, MySQL</p>
                    </div>
                </div>
            </div>
            ...
            <div className="dark:text-gray-300 text-gray-700 rounded-lg shadow-xl p-6 hover:shadow-2xl transition-shadow duration-300">
                <h3 className="text-2xl font-bold dark:text-gray-300 text-gray-700 mb-4">DevOps, Tools & Professional</h3>
                <div className="space-y-4">
                    <div>
                        <h4 className="text-xl font-semibold dark:text-gray-300 text-gray-700 mb-2">Tools & Platforms:</h4>
                        <p className="dark:text-gray-300 text-gray-700 leading-relaxed">Git, Docker, Linux, Bash, CI/CD</p>
                    </div>
                    {/* <div>
