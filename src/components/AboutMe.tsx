    ...
    return (
        <section id="about" className="card">
            ...
            <div className="grid md:grid-cols-3 gap-6 mb-6">
                ...
                <div className="md:col-span-2">
                    <p className="dark:text-gray-300 text-gray-700 leading-relaxed mb-4 text-lg">
                        I'm <span className="font-semibold text-gray-600 dark:text-gray-200">Ali Alizadeh</span>, a passionate Computer Engineering student with a deep fascination for technology's intersection with life sciences. My academic journey has led me to explore the exciting realms of <span className="font-semibold text-gray-600 dark:text-gray-200">machine learning</span>, <span className="font-semibold text-gray-600 dark:text-gray-200">natural language processing</span>, and <span className="font-semibold text-gray-600 dark:text-gray-200">computer vision</span>, with a focus on applying them to solve complex challenges in <span className="font-semibold text-gray-600 dark:text-gray-200">healthcare</span>.
                    </p>
